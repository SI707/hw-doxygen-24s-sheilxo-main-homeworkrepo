...
{
/**
     * @brief Displays the current status of the Othello game board.
     * 
     * The board is displayed with alternating black and white pieces.
     */
...
/**
     * @brief Makes a move in the Othello game.
     * 
     * The move string should be in the format "letter,number" (e.g., "A3").
     * After making the move, the function updates the game board and other game state variables.
     * 
     * @param move The move string representing the move to be made.
     */
...
/**
     * @brief Resets the Othello game board.
     * 
     * All pieces are removed from the board, and the initial configuration of black and white pieces is set.
     */
...
/**
     * @brief Checks if a move is legal in the current state of the Othello game.
     * 
     * A move is considered legal if it results in flipping at least one opponent's piece.
     * 
     * @param move The move string representing the move to be checked.
